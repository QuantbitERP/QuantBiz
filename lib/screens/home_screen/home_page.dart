...
class _HomePageState extends State<HomePage> {
  ...
  Widget homePage(HomeViewModel model){
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title:  Text(model.dashboard.company!=null?model.dashboard.company.toString() :model.employeeData.company.toString(),style: const TextStyle(fontSize: 20),),
        actions: [

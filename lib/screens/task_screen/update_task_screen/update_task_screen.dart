                ...
                child: fullScreenLoader(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  ...
                                  color: model.getColorForPriority(
                                      model.taskData.priority.toString()),
                                ),
                              ),
                              child: Padding(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                buildItemColumn(
                                    additionalText:
                                        (model.taskData.expectedTime ?? 0.0)
                                            .toString(),
                                    labelText: 'Expected Hrs'),
                                buildItemColumn(
                                    additionalText:
                                        (model.taskData.expEndDate ?? 0.0)
                                            .toString(),
                                    labelText: 'Due Date'),
                                buildItemColumn(
                                    additionalText:
                                        (model.taskData.actualTime ?? 0.0)
                                            .toString(),
                                    labelText: 'Actual Hrs'),
                              ],
                            ),
                          ),
                        ),
                        ...
                        buildItemColumn(
                            additionalText: model.taskData.description ?? "",
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                color:
                                    Colors.blueAccent, // Color of the divider
                              ),
                            ),
                            const SizedBox(
                              width: 10,
                            ...
                            ? ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return ListTile(
                                    ...
                                    subtitle: Text(
                                      "${comment.commentBy} | ${comment.creation}",
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold),
                                    ),
                                  );

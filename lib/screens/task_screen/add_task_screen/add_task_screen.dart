...
child: fullScreenLoader(
  ...
  child: Form(
    ...
    child: Column(
      children: [
        CustomDropdownButton2(value: model.taskData.project,prefixIcon: Icons.local_post_office_outlined,items: model.projectList, hintText: 'Select the project', labelText: 'Project', onChanged:  model.changeProject,
        validator: model.validate,),
        const SizedBox(
          height: 15,
        ),
        CustomSmallTextFormField(controller: model.subject, labelText: 'Subject', hintText:"Enter the subject",prefixIcon: Icons.subject,
        onChanged: model.changeSubject,validator: model.validate,),
        const SizedBox(
          height: 15,
        ),

        CustomSmallTextFormField(linelength: 3,controller: model.description, labelText: 'Description', hintText:"Enter the Description",
          onChanged: model.changeDescription,),

        const SizedBox(
          height: 15,
        ),
        CustomMultiDropdownButton2(items: model.userList, hintText: '', onChanged: model.onChanged, value: model.assignToList, labelText: 'Assign To'),
        const SizedBox(
          height: 15,
        ),
...
prefixIcon: Icon(Icons.flag),
        ...
        CustomDropdownButton2(value: model.taskData.parentTask,prefixIcon: Icons.file_open,items: model.parentTaskList, hintText: 'Select the Parent Task', labelText: 'Parent Task', onChanged:  model.changeParentTask,),
